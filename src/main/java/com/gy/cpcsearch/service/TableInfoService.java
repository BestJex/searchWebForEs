...
public class TableInfoService {
    ...
    public List<String> findAllAlias(){
        return tableInfoMapper.findAllAlias();
    };
    ...
    public List<TableInfo> findAllTable(){
        return tableInfoMapper.findAllTable();
    }
    ...
    public String getTimeFieldByName(String name){
        if(name==null||name.equals("")||name.contains(",")){
            return null;
        }
        String timeString = tableInfoMapper.getTimeFieldByName(name);
